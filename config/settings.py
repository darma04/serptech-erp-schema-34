...
if _USE_MULTI_TENANT:
    ...
    SHARED_APPS = [
        ...
        # 1. Development bisa akses langsung via localhost
...
# Jika di-set ke ".serptech.serpgroup.cloud", SEMUA tenant subdomain akan berbagi
